...
namespace MailSender.lib.Service
{
    ...
    class SmtpMailSender:IMailSender
    {
        ...
        public SmtpMailSender(string Address, int Port,
        ...
        public async Task SendAsync(string SenderAddress, string Subject, string Body,
        ...
        public async Task SendAsync(string SenderAddress, IEnumerable<string> RecipientsAddresses,
            string Subject, string Body,
        ...
        public async Task SendParallelAsync(string SenderAddress, IEnumerable<string> RecipientsAddresses, 
            string Subject, string Body,CancellationToken Cancel = default)
        {
            var tasks = RecipientsAddresses
                .Select(recipient_address => SendAsync(SenderAddress, recipient_address, Subject, Body));
