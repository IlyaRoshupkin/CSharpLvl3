...
namespace MailSender.lib.Reports
{
    public class StatisticReport
    {
        ...
        private void GenerateMainDocumentPart1Content(MainDocumentPart mainDocumentPart1)
        {
            ...
            Paragraph paragraph1 = new Paragraph() { RsidParagraphMarkRevision = "009730A6", RsidParagraphAddition = "00B12500", RsidRunAdditionDefault = "00A234E4" };
            ...
            Run run1 = new Run() { RsidRunProperties = "009730A6" };
            ...
            Text text1 = new Text();
            text1.Text = "The report";

            run1.Append(runProperties1);
            run1.Append(text1);

            Run run2 = new Run() { RsidRunProperties = "009730A6", RsidRunAddition = "009730A6" };
            ...
            Run run3 = new Run() { RsidRunProperties = "009730A6", RsidRunAddition = "009730A6" };
            ...
            Text text3 = new Text();
            text3.Text = "n of mail sending – statistic";
            ...
            Paragraph paragraph2 = new Paragraph() { RsidParagraphMarkRevision = "00A234E4", RsidParagraphAddition = "009730A6", RsidRunAdditionDefault = "009730A6" };
            ...
            Run run4 = new Run() { RsidRunProperties = "009730A6" };

            RunProperties runProperties4 = new RunProperties();
            Highlight highlight1 = new Highlight() { Val = HighlightColorValues.Red };
            Languages languages6 = new Languages() { Val = "en-US" };

            runProperties4.Append(highlight1);
            runProperties4.Append(languages6);
            Text text4 = new Text();
            text4.Text = "Messages were sent";
            ...
            SectionProperties sectionProperties1 = new SectionProperties() { RsidRPr = "00A234E4", RsidR = "009730A6" };
        ...
        private void GenerateDocumentSettingsPart1Content(DocumentSettingsPart documentSettingsPart1)
        {
            ...
            RsidRoot rsidRoot1 = new RsidRoot() { Val = "000E5BBF" };
            Rsid rsid1 = new Rsid() { Val = "000E5BBF" };
            Rsid rsid2 = new Rsid() { Val = "009730A6" };
            Rsid rsid3 = new Rsid() { Val = "00A234E4" };
            Rsid rsid4 = new Rsid() { Val = "00B12500" };
            ...
            W14.DocumentId documentId1 = new W14.DocumentId() { Val = "512C752C" };
            W15.ChartTrackingRefBased chartTrackingRefBased1 = new W15.ChartTrackingRefBased();
            W15.PersistentDocumentId persistentDocumentId1 = new W15.PersistentDocumentId() { Val = "{C2AD0B21-B033-4AD2-AC39-2EF9A95AF7E3}" };
        ...
        private void GenerateStyleDefinitionsPart1Content(StyleDefinitionsPart styleDefinitionsPart1)
        {
            ...
            Languages languages9 = new Languages() { Val = "ru-RU", EastAsia = "en-US", Bidi = "ar-SA" };
        ...
        {
            document.PackageProperties.Creator = "Илья";
            document.PackageProperties.Title = "";
            document.PackageProperties.Subject = "";
            document.PackageProperties.Keywords = "";
            document.PackageProperties.Description = "";
            document.PackageProperties.Revision = "3";
            document.PackageProperties.Created = System.Xml.XmlConvert.ToDateTime("2020-10-18T14:58:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.Modified = System.Xml.XmlConvert.ToDateTime("2020-10-18T15:01:00Z", System.Xml.XmlDateTimeSerializationMode.RoundtripKind);
            document.PackageProperties.LastModifiedBy = "Илья";
        }
